...
INFO_TEST_BUILD_PARENT_CONTAINNER ?= test-parent-template-docker-golang-exec-build
INFO_TEST_TAG_BUILD_IMAGE_NAME ?= bridgewwater/template-docker-golang-exec-build
